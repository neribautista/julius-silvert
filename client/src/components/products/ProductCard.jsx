...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="product-card">
      {product.isNew && <span className="product-card__tag badge badge-red">New</span>}
      ...
      <div className="product-card__body">
        ...
        {product.itemNumber && <p className="product-card__item">Item#: {product.itemNumber}</p>}
        ...
        <div className="product-card__price">
          {product.pricePerLb > 0
            ? <><strong>${product.pricePerLb.toFixed(2)}/lb</strong> <span>{product.caseSize}</span></>
        ...
        <div className="product-card__actions">
          ...
          />
          <button className="btn btn-primary btn-sm product-card__add" onClick={handleAdd} disabled={loading}>
            Add
          </button>
